...
public class OrderController {
	...
	public Page<OrderDTO> getOrdersByUserID(@PathVariable Long id, @PathParam(value = "page") int page, @PathParam(value = "size") int size){
		return orderService.getOrdersByUserID(id, page, size);
	}
